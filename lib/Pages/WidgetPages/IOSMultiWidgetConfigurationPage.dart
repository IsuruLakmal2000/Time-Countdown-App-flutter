...
class IOSMultiWidgetConfigurationPage extends StatefulWidget {
  const IOSMultiWidgetConfigurationPage({Key? key}) : super(key: key);

  @override
  State<IOSMultiWidgetConfigurationPage> createState() => _IOSMultiWidgetConfigurationPageState();
}

class _IOSMultiWidgetConfigurationPageState extends State<IOSMultiWidgetConfigurationPage> {
  ...
  Future<void> _loadData() async {
    try {
      print('Loading countdowns and widget configuration...');
      ...
      final widgetConfig = await CountdownWidgetService.getIOSWidgetIndicesConfiguration();
      
      // Load current frequency configuration
      final frequencyConfig = await CountdownWidgetService.getIOSWidgetFrequencyConfiguration();
      
      print('Loaded ${countdowns.length} countdowns');
      print('Current widget configuration: $widgetConfig');
      print('Current frequency configuration: $frequencyConfig');
  ...
  Future<void> _configureWidget(int widgetIndex, String countdownId) async {
    try {
      await CountdownWidgetService.configureIOSWidgetByIndexWithFrequency(widgetIndex, countdownId, _selectedFrequency);
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Widget $widgetIndex configured successfully!'),
        ...
        Container(
          ...
          child: const Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'Configure each widget individually. Each widget can display a different countdown.',
                  style: TextStyle(
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: ListTile(
                  ...
                  subtitle: Text(
                    isConfigured 
                        ? 'Showing: ${_getCountdownTitle(countdownId!)}\nUpdate: ${_getFrequencyDisplayName(_widgetFrequencyConfiguration[widgetIndex] ?? CountdownWidgetService.FREQUENCY_15_MIN)}'
                        : 'Tap to configure',
                    style: TextStyle(
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'Select countdown for Widget $_configuringWidgetIndex',
                  style: const TextStyle(
                    color: Colors.white,
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
        ...
        Container(
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                'Configure Widget $_configuringWidgetIndex',
                style: const TextStyle(
                  color: Colors.white,
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
