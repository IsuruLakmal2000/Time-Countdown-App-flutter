...
class _Template3State extends State<Template3> {
  ...
  Widget _buildTemplateContent() {
    return Column(
      ...
      children: [
        ...
        // Countdown Display with a Circular Progress Indicator
        Stack(
  ...
  Widget _buildCountdownDisplay() {
    return TemplateFunctions.shouldShowTimeUnit(
      unit: 'years',
      years: years,
      days: days,
      hours: hours,
      ...
      seconds: seconds,
        ...
        ? Row(
            ...
            children: [
              ...
              TemplateFunctions.shouldShowTimeUnit(
                unit: 'days',
                years: years,
                days: days,
                hours: hours,
  ...
  @override
  void didUpdateWidget(covariant Template3 oldWidget) {
